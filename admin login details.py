...
def save_to_database():
    ...
    try:
        ...
        cursor.execute("SELECT MAX(id) FROM admindetails")
        ...
        insert_query = "INSERT INTO admindetails (id, name, age, gender, contact_number, email, passwords) VALUES (%s,%s, %s, %s, %s, %s, %s)"
